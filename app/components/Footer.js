...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-slate-950 px-4 py-10 sm:px-6 lg:px-32">
        ...
        <div className="flex items-center gap-3">
          {socials.map((item) => (
            <Link
              ...
              className="rounded-xl border border-white/10 bg-white/5 p-2.5 text-slate-400 transition-all hover:-translate-y-0.5 hover:border-cyan-400/40 hover:bg-cyan-400/10 hover:text-cyan-300"
            >
              {item.icon}
            </Link>
          ))}
